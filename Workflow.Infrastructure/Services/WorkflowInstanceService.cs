    ...
    .FirstOrDefaultAsync(i => i.Id == instanceId);
     ...
     .Where(i => i.CreatedById == userId ||
       i.Steps.Any(s => s.AssignedToUserId == userId))
        ...
        public Task<ActionResultDto> ApproveAsync(int instanceId, string userId, string? comments = null)
            => ActOnInstanceAsync(instanceId, new InstanceActionDto { Action = "approve", Comments = comments }, userId);

        public Task<ActionResultDto> RejectAsync(int instanceId, string userId, string? comments = null)
            => ActOnInstanceAsync(instanceId, new InstanceActionDto { Action = "reject", Comments = comments }, userId);
